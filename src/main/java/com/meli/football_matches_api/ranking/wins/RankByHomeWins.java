...
@Component
public class RankByHomeWins implements Ranking {

    private final TeamRepository teamRepository;

    public RankByHomeWins(TeamRepository teamRepository) {
    ...
    public Comparator<TeamDTO> getComparator() {
        return Comparator.comparing(TeamDTO::getHomeWins).reversed();
    }
